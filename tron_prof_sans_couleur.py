...
class Board:
    ...
    def _game_over(self):
        ...
        print(ASCIIART[2]) # affiche l'ecran de game over
        sleep(1)
...
class Menu:
    def __init__(self):
        ...
        self.main_interface = f"{ASCIIART[0]}"
                          # choisi 4 couleurs au hasard pour le menu SANS EN REPRENDRE 1 deja repris dans la liste, on exclu reset et black
        self.selection_list = [
            f"Démarrer le jeu",
            f"Touches Clavier",
            f"Credits",
